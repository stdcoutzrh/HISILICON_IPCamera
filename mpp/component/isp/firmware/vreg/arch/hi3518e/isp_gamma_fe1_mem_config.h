...
#define HI_GAMMA_FE1_MEM_BASE_ADDR (0x2000)
#define HI_GAMMA_FE1_MEM_SIZE      (0x400)
...
// ------------------------------------------------------------------------------ //
// Register: hi_gamma_fe1_mem_array_data
// ------------------------------------------------------------------------------ //
...
static __inline void hi_gamma_fe1_mem_array_data_write(HI_U32 index, HI_U32 data) {
    HI_U32 addr = HI_GAMMA_FE1_MEM_BASE_ADDR + (index << 2);
    IOWR_32DIRECT(addr, data & 0xFFFFFFFF);
}
static __inline HI_U32 hi_gamma_fe1_mem_array_data_read(HI_U32 index) {
    HI_U32 addr = HI_GAMMA_FE1_MEM_BASE_ADDR + (index << 2);
