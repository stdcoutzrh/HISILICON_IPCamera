...
#define VMAX_720P30_LINEAR     (988+INCREASE_LINES)
...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    pstAeSnsDft->u8AeCompensation = 0x48;
...
HI_U32 cmos_get_isp_black_level(ISP_CMOS_BLACK_LEVEL_S *pstBlackLevel)
{
 ...
 #else
    pstBlackLevel->au16BlackLevel[0] = 0x00;
    pstBlackLevel->au16BlackLevel[1] = 0x00;
    pstBlackLevel->au16BlackLevel[2] = 0x00;
    pstBlackLevel->au16BlackLevel[3] = 0x00;
 #endif
