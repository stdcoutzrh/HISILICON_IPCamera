...
/******************************************************************************
* function :  H.264@720P@30fps+H.264@VGA@30fps

******************************************************************************/
HI_S32 VENC_720P_CLASSIC(HI_VOID)
{
	...
	******************************************/
	...
	//最大视频缓存池个数，实际用不到这么多，也不会真的给你分配这么多
	...
	******************************************/
	...
	//step6 is the key point of vedio encode and transmit video
	
	/******************************************
	 step 6: stream venc process -- get stream, then save it to file. 
	******************************************/
	
	//start get venc stream process thre
